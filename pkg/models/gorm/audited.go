...
type Mutable struct {
	...
	CreatedActorType string                 `json:"-" gorm:"column:created_actor_type;type:varchar(32);default:null;<-:create"`
	CreatedActorID   uint64                 `json:"-" gorm:"column:created_actor_id;type:bigint;default:null;<-:create"`
	UpdatedActorType string                 `json:"-" gorm:"column:updated_actor_type;type:varchar(32);default:null"`
	UpdatedActorID   uint64                 `json:"-" gorm:"column:updated_actor_id;type:bigint;default:null"`
}
