...
import (
	...
	assemblyai "github.com/rapidaai/api/assistant-api/internal/transformer/assembly-ai"
...
func TestAssemblyaiSTTLifecycle(t *testing.T) {
	...
	stt, err := assemblyai.NewSpeechToText(assemblyai.WithContext(ctx), assemblyai.WithLogger(logger), assemblyai.WithCredential(cred), assemblyai.WithOnPacket(collector.OnPacket), assemblyai.WithOptions(opts))
...
func TestAssemblyaiSTTAudioAcceptance(t *testing.T) {
	...
	stt, err := assemblyai.NewSpeechToText(assemblyai.WithContext(ctx), assemblyai.WithLogger(logger), assemblyai.WithCredential(
		testutil.BuildCredential(pcfg.Credential)), assemblyai.WithOnPacket(
		collector.OnPacket), assemblyai.WithOptions(
