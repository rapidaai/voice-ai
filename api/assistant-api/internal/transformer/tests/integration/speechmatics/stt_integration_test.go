...
func TestSpeechmaticsSTTLifecycle(t *testing.T) {
	...
	stt, err := speechmatics.NewSpeechToText(speechmatics.WithContext(ctx), speechmatics.WithLogger(logger), speechmatics.WithCredential(cred), speechmatics.WithOnPacket(collector.OnPacket), speechmatics.WithOptions(opts))
...
func TestSpeechmaticsSTTCloseWhileStreaming(t *testing.T) {
	...
	stt, err := speechmatics.NewSpeechToText(speechmatics.WithContext(ctx), speechmatics.WithLogger(logger), speechmatics.WithCredential(
		testutil.BuildCredential(pcfg.Credential)), speechmatics.WithOnPacket(
		collector.OnPacket), speechmatics.WithOptions(
