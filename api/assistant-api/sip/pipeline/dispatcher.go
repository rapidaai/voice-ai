...
type TransferServer interface {
	...
	MakeTransferBridgeCall(ctx context.Context, cfg *sip_config.Config, toURI, fromURI string, opts sip_runtime.TransferBridgeCallOptions) (*sip_runtime.Session, error)
