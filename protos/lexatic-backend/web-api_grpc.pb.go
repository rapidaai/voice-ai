...
const (
	...
	AuthenticationService_GetUsers_FullMethodName       = "/web_api.AuthenticationService/GetUsers"
...
func (c *authenticationServiceClient) ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*BaseResponse, error) {
	out := new(BaseResponse)
...
func (c *authenticationServiceClient) GetUsers(ctx context.Context, in *GetUsersRequest, opts ...grpc.CallOption) (*GetUsersResponse, error) {
	out := new(GetUsersResponse)
	err := c.cc.Invoke(ctx, AuthenticationService_GetUsers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthenticationServiceServer) ChangePassword(context.Context, *ChangePasswordRequest) (*BaseResponse, error) {
...
func (UnimplementedAuthenticationServiceServer) GetUsers(context.Context, *GetUsersRequest) (*GetUsersResponse, error) {
...
func _AuthenticationService_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUsersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthenticationServiceServer).GetUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthenticationService_GetUsers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticationServiceServer).GetUsers(ctx, req.(*GetUsersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthenticationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetUsers",
			Handler:    _AuthenticationService_GetUsers_Handler,
		},
		{
			MethodName: "Linkedin",
	...
	Metadata: "lexatic-backend/web-api.proto",
}
...
type OrganizationServiceClient interface {
	...
	UpdateOrganization(ctx context.Context, in *UpdateOrganizationRequest, opts ...grpc.CallOption) (*BaseResponse, error)
...
func (c *organizationServiceClient) UpdateOrganization(ctx context.Context, in *UpdateOrganizationRequest, opts ...grpc.CallOption) (*BaseResponse, error) {
	out := new(BaseResponse)
...
type OrganizationServiceServer interface {
	...
	UpdateOrganization(context.Context, *UpdateOrganizationRequest) (*BaseResponse, error)
...
func (UnimplementedOrganizationServiceServer) UpdateOrganization(context.Context, *UpdateOrganizationRequest) (*BaseResponse, error) {
...
type ProjectServiceClient interface {
	...
	GetAllProject(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllProjectResponse, error)
...
func (c *projectServiceClient) GetAllProject(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllProjectResponse, error) {
...
type ProjectServiceServer interface {
	...
	GetAllProject(context.Context, *emptypb.Empty) (*GetAllProjectResponse, error)
...
func (UnimplementedProjectServiceServer) GetAllProject(context.Context, *emptypb.Empty) (*GetAllProjectResponse, error) {
...
func _ProjectService_GetAllProject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProjectServiceServer).GetAllProject(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
const (
	LeadService_CreateLead_FullMethodName = "/web_api.LeadService/CreateLead"
)
...
type LeadServiceClient interface {
	CreateLead(ctx context.Context, in *LeadCreationRequest, opts ...grpc.CallOption) (*BaseResponse, error)
}
...
func (c *leadServiceClient) CreateLead(ctx context.Context, in *LeadCreationRequest, opts ...grpc.CallOption) (*BaseResponse, error) {
	out := new(BaseResponse)
	err := c.cc.Invoke(ctx, LeadService_CreateLead_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedLeadServiceServer
// for forward compatibility
type LeadServiceServer interface {
	CreateLead(context.Context, *LeadCreationRequest) (*BaseResponse, error)
}

// UnimplementedLeadServiceServer should be embedded to have forward compatible implementations.
type UnimplementedLeadServiceServer struct {
}

func (UnimplementedLeadServiceServer) CreateLead(context.Context, *LeadCreationRequest) (*BaseResponse, error) {
...
func _LeadService_CreateLead_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LeadServiceServer).CreateLead(ctx, req.(*LeadCreationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LeadService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "web_api.LeadService",
