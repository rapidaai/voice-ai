...
type EndpointServiceClient interface {
	GetAllEndpoint(c context.Context, projectId, organizationId uint64, page, pageSize uint32) (*_api.GetAllEndpointResponse, error)
...
type WebhookServiceClient interface {
	...
	GetAllWebhook(ctx context.Context, organizationId, projectId uint64, page, pageSize uint32) (*_api.GetAllWebhookResponse, error)
