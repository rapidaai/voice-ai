...
export const useConversationLogPageStore = create<ConversationLog>(
  (set, get) => ({
    ...
    columns: [
      ...
      { name: 'STT', key: 'stt.latency_ms', visible: true },
      { name: 'Agent', key: 'agent.latency_ms', visible: true },
      {
        name: 'TTFT',
        key: 'agent.ttft_ms',
        visible: true,
      },
      { name: 'TTS', key: 'tts.latency_ms', visible: true },
      { name: 'EOS', key: 'eos.latency_ms', visible: true },
